...
tiles keep their dark side gutters inside a thin background-colored outer frame. Every tile
...
The result is `artifacts/CodexKeypad_0_2_10.lplug4`. Install it, find the Codex
